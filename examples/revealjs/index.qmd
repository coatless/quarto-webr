...
:::{.callout-important}
This template requires [Quarto 1.4.554 or greater](https://quarto.org/docs/download/), which carries the updated copy of `pandoc` it depends on. That copy first shipped in the 1.4.502 pre-release, so no pre-release download is needed any more; these examples are built with Quarto 1.10.18. For more details, please see [Issue #14](https://github.com/coatless/quarto-webr/issues/14).
:::
