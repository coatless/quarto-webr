...
**Example**: You can find an example of an HTML document template [here](https://github.com/coatless/quarto-webr/tree/main/examples/html-document).
...
**Example**: Explore an example of a website template [here](https://github.com/coatless/quarto-webr/tree/main/examples/website).
...
**Example**: You can view an example of a book template [here](https://github.com/coatless/quarto-webr/tree/main/examples/book).
