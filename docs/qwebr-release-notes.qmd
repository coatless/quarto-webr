...
- Added an RevealJS presentation example ([#84](https://github.com/coatless/quarto-webr/issues/84)).
- Added examples of embedding a RevealJS presentation inside of a website and book project ([#84](https://github.com/coatless/quarto-webr/issues/84)).
